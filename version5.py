...
def PAIR_DATA_CREATION(share_for_show_data):
        ...
        master['Show name']=share_for_show_data
...
def CHAR_PAIR_EMO(share_for_show_data):
        ...
        master.rename(columns={'pair_emo_contribution':'feature_contribution','sd_onehalf_con':'threshold',
        ...
        master2=master1.append(master,ignore_index=True)
        return master2
